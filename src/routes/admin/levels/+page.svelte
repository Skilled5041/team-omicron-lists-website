    ...
    <form action="?/submit" method="POST" use:enhance>
        ...
        {:else if currentOperation === "edit"}
            ...
            <label class="pb-4">
                ...
                <input type="text" name="newGdpsId" class="input" placeholder="New GDDPS Server ID"/>
                {#if form?.gdpsIdError}
                    <span class="text-error-400-500-token">{form.message}</span>
                {/if}
            </label>
            <label class="pb-4">
				<span class="pb-1 block"
                >New Verification Video URL</span
                >
                <span class="input-group input-group-divider flex flex-row items-center">
					<span class="pl-4 pr-4 text-surface-600-300-token">https://</span>
					<input
            ...
            <label class="pb-4">
                ...
                >New Verifier</span
                >
                <input type="text" name="newVerifier" class="input" placeholder="New Verifier"/>
                {#if form?.verifierError}
                    <span class="text-error-400-500-token">{form.message}</span>
                {/if}
            </label>
            ...
            <label class="pb-4">
				<span class="pb-1 block"
                >New Minimum List Percentage</span
                >
                <input
                        type="number"
